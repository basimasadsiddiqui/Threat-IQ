...
## Output
- Composition directory: `brag-output-linkedin/composition/`
- Rendered video: `brag-output-linkedin/brag.mp4`
...
- Vertical layout: stacked cards in a single column, designed for 1080x1920 —
  do NOT letterbox a landscape console screenshot.

## Storyboard
Use `brag-output-linkedin/brag-plan.md` as the creative contract.
